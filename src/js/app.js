...
function iniciarApp(){
    ...
    idCliente();
    nombreCliente(); //añade el nombre del cliente al obejto de cita
    seleccionarFecha();//añade la fecha en el objeto
    seleccionarHora();//añade la hora de la cita en el objeto

    mostarResumen();//Muestra el resumen del cita
...
function seleccionarServicio(servicio){
    ...
    if(servicios.some(agregado => agregado.id === id)){
        //Eliminarlo si ya fue seleccionado
...
function mostrarAlerta(mensaje,tipo,elemento,desaparece = true){
    ...
    //Previene que se generen mas 1 alerta
